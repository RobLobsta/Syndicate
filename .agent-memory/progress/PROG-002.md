...
| `blender-tool` (D09) | in_progress | 7 stages, TV-001..TV-012 self-verification, 68 unit tests. Cells are true Voronoi cells on planar sources and not on curved ones (DEV-005); `test_complex_hollow` fails outright (DEV-004) |
