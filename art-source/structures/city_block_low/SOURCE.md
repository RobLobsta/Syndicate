# city_block_low — source model

**Becomes:** `str_city_block_low_01`, a six-storey concrete block.

| | |
|---|---|
| Arrived as | `art-source/city_alley_kit.blend`, uploaded 2026-08-18 (commit `b8c84bc`) |
| Extracted | 2026-08-18, into `scene.glb` |
| Extent | 10.14 × 7.83 × 17.12 m (X × Z × Y in game axes) |
| Triangles | 946 across 2 objects |
| Textures | packed in the `.blend`, carried into `scene.glb` |
| Origin | BlenderKit, asset `ca8fbde2-e023-4f8c-b7fb-68c96e6880ff` |
