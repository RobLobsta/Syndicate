# street_bench — source model

**Becomes:** `str_street_bench_01`, a park bench.

| | |
|---|---|
| Arrived as | `art-source/city_alley_kit.blend`, uploaded 2026-08-18 (commit `b8c84bc`) |
| Extracted | 2026-08-18, into `scene.glb` |
| Extent | 1.91 × 0.74 × 0.97 m (X × Z × Y in game axes) |
| Triangles | 4,416 across 4 objects |
| Textures | packed in the `.blend`, carried into `scene.glb` |
| Origin | BlenderKit, asset `1ba233de-b47e-4290-8c8f-05649608d327` |
