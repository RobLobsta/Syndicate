# street_tree — source model

**Becomes:** `str_street_tree_01`, a street tree.

| | |
|---|---|
| Arrived as | `art-source/city_alley_kit.blend`, uploaded 2026-08-18 (commit `b8c84bc`) |
| Extracted | 2026-08-18, into `scene.glb` |
| Extent | 1.07 × 1.07 × 2.05 m (X × Z × Y in game axes) |
| Triangles | 1,134 across 1 objects |
| Textures | packed in the `.blend`, carried into `scene.glb` |
| Origin | BlenderKit, asset `no id survives` |
